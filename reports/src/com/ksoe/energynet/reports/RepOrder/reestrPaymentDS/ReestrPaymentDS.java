package com.ksoe.energynet.reports.RepOrder.reestrPaymentDS;
...
public class ReestrPaymentDS extends JRMapArrayDataSource implements
	...
	public static final String BILLITEMCODES = "billitemcodes";
	...
	private static final JRField[] fields = new JRField[] {
		...
		new DSField(BILLITEMCODES, String.class),
