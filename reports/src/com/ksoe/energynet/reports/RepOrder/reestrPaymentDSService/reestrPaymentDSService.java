package com.ksoe.energynet.reports.RepOrder.reestrPaymentDSService;
...
public class reestrPaymentDSService extends JRMapArrayDataSource implements
	...
	public static final String PRIHOD_DATE = "prihod_date";
	...
	private reestrPaymentDSService() {
		super(null);
	}

	public reestrPaymentDSService(Object[] arg0) {
		super(arg0);
	}
