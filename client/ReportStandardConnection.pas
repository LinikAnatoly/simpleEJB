...
type
  TfrmReportStandardConnection = class(TDialogForm)
    btnOk: TBitBtn;
    btnCancel: TBitBtn;
    lblDate: TLabel;
...
var
  frmReportStandardConnection: TfrmReportStandardConnection;
...
procedure TfrmReportStandardConnection.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TfrmReportStandardConnection.btnOkClick(Sender: TObject);
var
...
reportName := 'Services/StandardConnection/StandardConnection';
