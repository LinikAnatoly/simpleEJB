...
unit EditENEstimateItem2ENEstimateItemSCCounter;
...
type
  TfrmENEstimateItem2ENEstimateItemEditSCCounter = class(TDialogForm)
  ...
  btnCancel: TButton;
    ...
    sgSCCounterIN: TAdvStringGrid;
    sgSCCounterOUT: TAdvStringGrid;
...
var
  frmENEstimateItem2ENEstimateItemEditSCCounter: TfrmENEstimateItem2ENEstimateItemEditSCCounter;
...
uses DMReportsUnit, FINMaterialsController, FINMaterialsStatusController,
  ...
  TKAccountingTypeController, TKMaterialsController;
...
var
  ...
  ENFINMaterialsHeaders_: array [1..25] of String =
        ( 'Код'
          ,'Номенклатурний №'
          ,'Назва'
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.FormShow(Sender: TObject);
begin
  SetGridHeaders(SCCounterHeaders, sgSCCounterIN.ColumnHeaders);
  SetGridHeaders(SCCounterHeaders, sgSCCounterOUT.ColumnHeaders);
  ...
  DisableActions([actAddEstimateItem]);
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.FormClose(Sender: TObject;  var Action: TCloseAction);
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.spbPlanInClick(
  Sender: TObject);
var
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.updateENEstimateItemGrid(grid : TAdvStringGrid; planCode : Integer);
var
 i , j: Integer;
...
begin
   ...
   grid.RemoveCheckBox(1,1);
    ...
    TempENEstimateItem := HTTPRIOENEstimateItem as ENEstimateItemControllerSoapPort;
       ...
       estimateItemFilter.accountingTypeRef.code := TK_ACCOUNTINGTYPE_COUNTER;
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.spbPlanOutClick(
  Sender: TObject);
var
   planFilter : ENPlanWorkFilter;
   estimateFilter : ENEstimateItemFilter;
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.sgENEstimateItemINClick(
  Sender: TObject);
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.updateENFINMaterialsGrid();
var
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.updateENFINMaterialsGrid_(grid: TAdvStringGrid; estimateCode: Integer);
var
  TempFINMaterials: FINMaterialsControllerSoapPort;
  i, j{, estimateItemCode}: Integer;
  l: FINMaterialsShortList;
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.sgENEstimateItemINCheckBoxClick(
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.sgENEstimateItemOUTCheckBoxClick(
  Sender: TObject; ACol, ARow: Integer; State: Boolean);
begin
  inherited;
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.btnSaveClick(
  Sender: TObject);
var
  ...
  end;
{
  ...
  if (eCodeIN = LOW_INT) or (eCodeOUT = LOW_INT)
  //or (fCode = LOW_INT)
  then
  begin
  ...
  ENEstimateItem2ENEstimateItemObj.typeRef.code := ENESTIMATEITEM2ENESTIMATEITEM_TYPE_COUNTER_MOVED;

     if (ENEstimateItem2ENEstimateItemObj.countGen = nil ) then
       ENEstimateItem2ENEstimateItemObj.countGen := TXSDecimal.Create;

     ENEstimateItem2ENEstimateItemObj.countGen.decimalString := '1';
  ...
  TempENEstimateItem2ENEstimateItem := HTTPRIOENEstimateItem2ENEstimateItem as ENEstimateItem2ENEstimateItemControllerSoapPort;
  TempENEstimateItem2ENEstimateItem.addMoveSCCounter(ENEstimateItem2ENEstimateItemObj);
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.updateEstimateItemGrid_(grid : TAdvStringGrid; estimateCode : Integer);
var
...

{
   ...
   begin
     ...
     e2eFilter.typeRef.code := ENESTIMATEITEM2ENESTIMATEITEM_TYPE_COUNTER_MOVED;
   end;
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.sgENEstimateItemOUTClick(
  Sender: TObject);
var estimateCode: Integer;
begin
  try
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.deleteENEstimateItem2ENEstimateItem(
  ...
  begin
    if e2eList.list[i] <> nil then
      if e2eList.list[i].code > LOW_INT then
        TempENEstimateItem2ENEstimateItem.removeMoveSCCounter(e2eList.list[i].code);
  end;
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.actDeleteForINExecute(
  Sender: TObject);
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.actDeleteForOUTExecute(
  Sender: TObject);
var estimateItemINCode, estimateItemOUTCode: Integer;
begin
  try
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.sgENFINMaterialsINCheckBoxClick(
  Sender: TObject; ACol, ARow: Integer; State: Boolean);
begin
  inherited;
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.actEditPlanINExecute(
  Sender: TObject);
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.actEditPlanOUTExecute(
  Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
    //tPlan : ENPlanWork;
    //ObjCode: Integer;
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.sgENFINMaterialsINClick(
  Sender: TObject);
begin
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.btnEditMaterialsClick(
  Sender: TObject);
begin
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.actUpdatePlanINExecute(
  Sender: TObject);
begin
  if planIN = nil then Exit;
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.actUpdatePlanOUTExecute(
  Sender: TObject);
begin
  if planOut = nil then Exit;
...
procedure TfrmENEstimateItem2ENEstimateItemEditSCCounter.actAddEstimateItemExecute(
  Sender: TObject);
var
 TempENEstimateItem: ENEstimateItemControllerSoapPort;
 eObj : ENEstimateItem;
...
begin
  ...
  try
    eCode := StrToInt(sgENEstimateItemIN.Cells[0, sgENEstimateItemIN.Row]);
    sgENEstimateItemIN.GetCheckBoxState(1, sgENEstimateItemIN.Row, state_ );
    if not state_ then eCode := StrToInt( FloatToStr(1/0));
  except
    ShowMessage('Оберіть матеріал, який треба перекинути ...');
    Exit;
  end;

      TempENEstimateItem := HTTPRIOENEstimateItem as ENEstimateItemControllerSoapPort;

  eObj := TempENEstimateItem.getObject(eCode);

  if (eObj = nil) then
  begin
    ShowMessage('Error on get Estimate');
    Exit;
  end;
    ...
    ENEstimateItemObj.accountingTypeRef := TKAccountingTypeRef.Create;
    ENEstimateItemObj.accountingTypeRef.code := TK_ACCOUNTINGTYPE_COUNTER;

    ENEstimateItemObj.materialRef := TKMaterialsRef.Create;
    ENEstimateItemObj.materialRef.code := eObj.materialRef.code;


    ENEstimateItemObj.countFact := TXSDecimal.Create;
    ENEstimateItemObj.countFact.DecimalString := '1';
    ...
    try
      ...
      ///
      frmENEstimateItemEdit.DisableControls([frmENEstimateItemEdit.spbMaterialName, frmENEstimateItemEdit.edtCountFact]);
