...
type
  TfrmENCargoPlanShow = class(TChildForm)
...
procedure TfrmENCargoPlanShow.FormClose(Sender: TObject; var Action: TCloseAction);
  begin
    if FormMode = fmChild then
      frmENCargoPlanShow:=nil;
    inherited;
  end;


procedure TfrmENCargoPlanShow.FormShow(Sender: TObject);
var
...
procedure TfrmENCargoPlanShow.sgENPlanWorkTopLeftChanged(Sender: TObject);
var
  TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENCargoPlanShow.sgENPlanWorkDblClick(Sender: TObject);
Var
temp : Integer;
begin
...
procedure TfrmENCargoPlanShow.UpdateGrid(Sender: TObject);
Var i, j: Integer;
begin
...
procedure TfrmENCargoPlanShow.actViewExecute(Sender: TObject);
...
procedure TfrmENCargoPlanShow.actEditExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
    tPlan : ENPlanWork;
    ObjCode: Integer;
begin
...
procedure TfrmENCargoPlanShow.actDeleteExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENCargoPlanShow.actInsertExecute(Sender: TObject);
var TempENPlanWork: ENPlanWorkControllerSoapPort;
...
begin
  ...
  try
    frmENCargoPlanEdit := TfrmENCargoPlanEdit.Create(Application, dsInsert);
    try

      frmENCargoPlanEdit.ENPlanWorkObj:=ENPlanWork.Create;
      SetNullIntProps(frmENCargoPlanEdit.ENPlanWorkObj);
      SetNullXSProps(frmENCargoPlanEdit.ENPlanWorkObj);
      // frmENCargoPlanEdit.ENPlanWorkObj.dateGen:= TXSDate.Create; NET-4213
      frmENCargoPlanEdit.ENPlanWorkObj.dateEdit:= TXSDate.Create;
      frmENCargoPlanEdit.isTransport := true;

      frmENCargoPlanEdit.cbPlanWorkKind.ItemIndex := ENPLANWORKKIND_YEAR - 1;

      if frmENCargoPlanEdit.ShowModal = mrOk then

      begin
        if frmENCargoPlanEdit.ENPlanWorkObj<>nil then
        ...
        begin
         ...
         ENPlanWorkItemObj := TempENPlanWorkItem.getObject(frmENCargoPlanEdit.itemCode);
         ...
         if ShowModal = mrOk then
          ...
          begin
            ...
            ENPlanWorkFilter(FilterObject).code := frmENCargoPlanEdit.ENPlanWorkObj.code;
            ENPlanWorkFilter(FilterObject).conditionSQL := ' enplanwork.statuscode <> ' + IntToStr(ENPLANWORKSTATUS_OLDER);
          end;
          /////
      ...
      frmENCargoPlanEdit.Free;
      frmENCargoPlanEdit:=nil;
    end;
  finally
    //ENPlanWorkObj.Free;
  end;
...
procedure TfrmENCargoPlanShow.actUpdateExecute(Sender: TObject);
  begin
  selectedRow := sgENPlanWork.Row;
  UpdateGrid(Sender);
...
procedure TfrmENCargoPlanShow.actFilterExecute(Sender: TObject);
...
procedure TfrmENCargoPlanShow.actNoFilterExecute(Sender: TObject);
begin
  FilterObject.Free;
  FilterObject := nil;
  UpdateGrid(Sender);
...
procedure TfrmENCargoPlanShow.actEstimateExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
begin
...
procedure TfrmENCargoPlanShow.actCancelEstimateExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
begin
...
procedure TfrmENCargoPlanShow.actClosePlanExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
    ENPlanWorkList: ENPlanWorkShortList;
    ENPlanWorkFilterObj: ENPlanWorkFilter;
    ObjCode: Integer;
...
procedure TfrmENCargoPlanShow.actMovePlanExecute(Sender: TObject);
Var
...
procedure TfrmENCargoPlanShow.actCorrectPlanExecute(Sender: TObject);
begin
{
...
procedure TfrmENCargoPlanShow.actAddPlanItemsExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
tPlan : ENPlanWork;
begin
  try
...
procedure TfrmENCargoPlanShow.actMakeNPZExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENCargoPlanShow.PopupMenu1Popup(Sender: TObject);
var
  plan : ENPlanWork;
  ObjCode : Integer;
...
procedure TfrmENCargoPlanShow.actPreConfirmExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENCargoPlanShow.actConfirmExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENCargoPlanShow.actUndoConfirmExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENCargoPlanShow.actCreatePackExecute(Sender: TObject);
Var
//TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENCargoPlanShow.actUnCloseExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENCargoPlanShow.actSaveAddInfoExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
tPlan : ENPlanWork;
