unit ReportServicesFromSideByTransport;
...
type
  TfrmReportServicesFromSideByTransport = class(TDialogForm)
    btnOk: TBitBtn;
    btnCancel: TBitBtn;
    lblDate: TLabel;
...
var
  frmReportServicesFromSideByTransport: TfrmReportServicesFromSideByTransport;
...
procedure TfrmReportServicesFromSideByTransport.btnCancelClick(Sender: TObject);
begin
  Self.Close;
end;

procedure TfrmReportServicesFromSideByTransport.btnOkClick(Sender: TObject);
var
...
begin
  ...
  makeReport('transport/servicesFromSideByTransport', argNames, args, 'xls');

  Self.Close;

end;

procedure TfrmReportServicesFromSideByTransport.FormCreate(Sender: TObject);
begin
    transportRealCode := -1;
    carName := 'Невідомо';
end;

procedure TfrmReportServicesFromSideByTransport.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TfrmReportServicesFromSideByTransport.spbTransportRealClick(Sender: TObject);
var
