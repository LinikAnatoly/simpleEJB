...
unit ShowENDepartmentFromSprav;
...
type
  ...
  TfrmENDepartmentFromSpravShow = class(TChildForm)  
...
var
  ...
  LastRow: Integer = 1;
  ENDepartmentFromSpravHeaders: array [1..5] of String =
        ( 'Код'
...
procedure TfrmENDepartmentFromSpravShow.FormClose(Sender: TObject; var Action: TCloseAction);
  begin
    if FormMode = fmChild then
      frmENDepartmentFromSpravShow:=nil;
    inherited;
  end;


procedure TfrmENDepartmentFromSpravShow.FormShow(Sender: TObject);
...
var
  ...
  ENDepartmentList := TempENDepartment.getDepartmentListFromSprav(ENDepartmentFilter(FilterObject),0,-1);
...
procedure TfrmENDepartmentFromSpravShow.UpdateGrid(Sender: TObject; updateMode : TUpdateMode);
Var i, j: Integer;
begin
{
...
procedure TfrmENDepartmentFromSpravShow.actViewExecute(Sender: TObject);
...
procedure TfrmENDepartmentFromSpravShow.actEditExecute(Sender: TObject);
Var TempENDepartment: ENDepartmentControllerSoapPort;
begin
 TempENDepartment := HTTPRIOENDepartment as ENDepartmentControllerSoapPort;
   try
...
procedure TfrmENDepartmentFromSpravShow.actDeleteExecute(Sender: TObject);
Var TempENDepartment: ENDepartmentControllerSoapPort;
  ObjCode: Integer;
begin
 TempENDepartment := HTTPRIOENDepartment as ENDepartmentControllerSoapPort;
...
procedure TfrmENDepartmentFromSpravShow.actInsertExecute(Sender: TObject);
Var TempENDepartment: ENDepartmentControllerSoapPort;
begin
  TempENDepartment := HTTPRIOENDepartment as ENDepartmentControllerSoapPort;
...
procedure TfrmENDepartmentFromSpravShow.actUpdateExecute(Sender: TObject);
  begin
  UpdateGrid(Sender, umEdit);
end;


procedure TfrmENDepartmentFromSpravShow.actFilterExecute(Sender: TObject);
begin
...
procedure TfrmENDepartmentFromSpravShow.actNoFilterExecute(Sender: TObject);
begin
  FilterObject.Free;
  FilterObject := nil;
  if isShowAll then
...
procedure TfrmENDepartmentFromSpravShow.tvDep1DblClick(Sender: TObject);
var
...
procedure TfrmENDepartmentFromSpravShow.actSelectExecute(Sender: TObject);
Var
temp : Integer;
begin
...
procedure TfrmENDepartmentFromSpravShow.FormCreate(Sender: TObject);
begin
