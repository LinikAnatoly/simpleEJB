...
type
  TfrmENPlanTransShow = class(TChildForm)
...
procedure TfrmENPlanTransShow.FormClose(Sender: TObject; var Action: TCloseAction);
  begin
    if FormMode = fmChild then
      frmENPlanTransShow:=nil;
    inherited;
  end;


procedure TfrmENPlanTransShow.FormShow(Sender: TObject);
var
...
procedure TfrmENPlanTransShow.sgENPlanWorkTopLeftChanged(Sender: TObject);
var
  TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENPlanTransShow.sgENPlanWorkDblClick(Sender: TObject);
Var
temp : Integer;
begin
...
procedure TfrmENPlanTransShow.UpdateGrid(Sender: TObject);
Var i, j: Integer;
begin
...
procedure TfrmENPlanTransShow.actViewExecute(Sender: TObject);
...
procedure TfrmENPlanTransShow.actEditExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
    tPlan : ENPlanWork;
    ObjCode: Integer;
begin
...
procedure TfrmENPlanTransShow.actDeleteExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENPlanTransShow.actInsertExecute(Sender: TObject);
var TempENPlanWork: ENPlanWorkControllerSoapPort;
...
begin
  ...
  try
    frmENPlanTransPortEdit := TfrmENPlanTransPortEdit.Create(Application, dsInsert);
    try

      frmENPlanTransPortEdit.ENPlanWorkObj:=ENPlanWork.Create;
      SetNullIntProps(frmENPlanTransPortEdit.ENPlanWorkObj);
      SetNullXSProps(frmENPlanTransPortEdit.ENPlanWorkObj);
      //frmENPlanTransPortEdit.ENPlanWorkObj.dateGen:= TXSDate.Create; NET-4213
      frmENPlanTransPortEdit.ENPlanWorkObj.dateEdit:= TXSDate.Create;
      frmENPlanTransPortEdit.isTransport := true;

      frmENPlanTransPortEdit.cbPlanWorkKind.ItemIndex := ENPLANWORKKIND_YEAR - 1;

      if frmENPlanTransPortEdit.ShowModal = mrOk then

      begin
        if frmENPlanTransPortEdit.ENPlanWorkObj<>nil then
        ...
        begin
         ...
         ENPlanWorkItemObj := TempENPlanWorkItem.getObject(frmENPlanTransPortEdit.itemCode);
         ...
         if ShowModal = mrOk then
          ...
          begin
            ...
            SetNullIntProps(FilterObject);
            SetNullXSProps(FilterObject);
            ENPlanWorkFilter(FilterObject).code := frmENPlanTransPortEdit.ENPlanWorkObj.code;
            ENPlanWorkFilter(FilterObject).conditionSQL := ' enplanwork.statuscode <> ' + IntToStr(ENPLANWORKSTATUS_OLDER);
          end;
          /////
      ...
      frmENPlanTransPortEdit.Free;
      frmENPlanTransPortEdit:=nil;
    end;
  finally
    //ENPlanWorkObj.Free;
  end;
...
procedure TfrmENPlanTransShow.actUpdateExecute(Sender: TObject);
  begin
  selectedRow := sgENPlanWork.Row;
  UpdateGrid(Sender);
...
procedure TfrmENPlanTransShow.actFilterExecute(Sender: TObject);
...
procedure TfrmENPlanTransShow.actNoFilterExecute(Sender: TObject);
begin
  FilterObject.Free;
  FilterObject := nil;
  UpdateGrid(Sender);
...
procedure TfrmENPlanTransShow.actEstimateExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
begin
...
procedure TfrmENPlanTransShow.actCancelEstimateExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
begin
...
procedure TfrmENPlanTransShow.actClosePlanExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
    ENPlanWorkList: ENPlanWorkShortList;
    ENPlanWorkFilterObj: ENPlanWorkFilter;
    ObjCode: Integer;
...
procedure TfrmENPlanTransShow.actMovePlanExecute(Sender: TObject);
Var
...
procedure TfrmENPlanTransShow.actCorrectPlanExecute(Sender: TObject);
begin
{
...
procedure TfrmENPlanTransShow.actAddPlanItemsExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
tPlan : ENPlanWork;
begin
  try
...
procedure TfrmENPlanTransShow.actMakeNPZExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENPlanTransShow.PopupMenu1Popup(Sender: TObject);
var
  plan : ENPlanWork;
  ObjCode : Integer;
...
procedure TfrmENPlanTransShow.actPreConfirmExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENPlanTransShow.actConfirmExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENPlanTransShow.actUndoConfirmExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENPlanTransShow.actCreatePackExecute(Sender: TObject);
Var
//TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENPlanTransShow.actUnCloseExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENPlanTransShow.actSaveAddInfoExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
tPlan : ENPlanWork;
