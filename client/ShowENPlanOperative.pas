...
type
  TfrmENPlanOperativeShow = class(TChildForm)
...
procedure TfrmENPlanOperativeShow.FormClose(Sender: TObject; var Action: TCloseAction);
  begin
    if FormMode = fmChild then
      frmENPlanOperativeShow:=nil;
    inherited;
  end;


procedure TfrmENPlanOperativeShow.FormShow(Sender: TObject);
var
...
procedure TfrmENPlanOperativeShow.sgENPlanWorkTopLeftChanged(Sender: TObject);
var
  TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENPlanOperativeShow.sgENPlanWorkDblClick(Sender: TObject);
Var
temp : Integer;
begin
...
procedure TfrmENPlanOperativeShow.UpdateGrid(Sender: TObject);
Var i, j: Integer;
begin
...
procedure TfrmENPlanOperativeShow.actViewExecute(Sender: TObject);
...
begin
  ...
  frmENPlanWorkEdit.isOperative := true;
  try
...
procedure TfrmENPlanOperativeShow.actEditExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
    tPlan : ENPlanWork;
    ObjCode: Integer;
begin
...
procedure TfrmENPlanOperativeShow.actDeleteExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENPlanOperativeShow.actInsertExecute(Sender: TObject);
var TempENPlanWork: ENPlanWorkControllerSoapPort;
begin
  TempENPlanWork := HTTPRIOENPlanWork as ENPlanWorkControllerSoapPort;
...
procedure TfrmENPlanOperativeShow.actUpdateExecute(Sender: TObject);
  begin
  selectedRow := sgENPlanWork.Row;
  UpdateGrid(Sender);
...
procedure TfrmENPlanOperativeShow.actFilterExecute(Sender: TObject);
...
begin
  ...
  try
    ...
    frmENPlanWorkFilterEdit.DisableControls([frmENPlanWorkFilterEdit.edtWorkState,
       frmENPlanWorkFilterEdit.spbENPlanWorkState]);

    ENPlanWorkFilterObj.stateRef := ENPlanWorkStateRef.Create();
    ENPlanWorkFilterObj.stateRef.code := ENPLANWORKSTATE_SIDEWORKS; //7;
    frmENPlanWorkFilterEdit.edtWorkState.Text := 'Роботи на сторону';

    frmENPlanWorkFilterEdit.isOperative := true;
...
procedure TfrmENPlanOperativeShow.actNoFilterExecute(Sender: TObject);
begin
  FilterObject.Free;
  FilterObject := nil;
  UpdateGrid(Sender);
...
procedure TfrmENPlanOperativeShow.actEstimateExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
begin
...
procedure TfrmENPlanOperativeShow.actCancelEstimateExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
begin
...
procedure TfrmENPlanOperativeShow.actClosePlanExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
    ENPlanWorkList: ENPlanWorkShortList;
    ENPlanWorkFilterObj: ENPlanWorkFilter;
    ObjCode: Integer;
...
procedure TfrmENPlanOperativeShow.actMovePlanExecute(Sender: TObject);
Var
...
procedure TfrmENPlanOperativeShow.actCorrectPlanExecute(Sender: TObject);
begin
{
...
procedure TfrmENPlanOperativeShow.actAddPlanItemsExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
tPlan : ENPlanWork;
begin
  try
...
procedure TfrmENPlanOperativeShow.actMakeNPZExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENPlanOperativeShow.PopupMenu1Popup(Sender: TObject);
var
  plan : ENPlanWork;
  ObjCode : Integer;
...
procedure TfrmENPlanOperativeShow.actPreConfirmExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENPlanOperativeShow.actConfirmExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENPlanOperativeShow.actUndoConfirmExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENPlanOperativeShow.actCreatePackExecute(Sender: TObject);
Var
//TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENPlanOperativeShow.actUnCloseExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENPlanOperativeShow.actSaveAddInfoExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
tPlan : ENPlanWork;
