...
type
  TfrmENAVRPlanShow = class(TChildForm)
...
uses Main, EditENPlanWork, EditENPlanWorkFilter, ENConsts,
  ...
  EditENAVRPlan, ENPlanWorkFormController, EditChangeObjectForPlan;
...
procedure TfrmENAVRPlanShow.FormClose(Sender: TObject; var Action: TCloseAction);
  begin
    if FormMode = fmChild then
      frmENAVRPlanShow:=nil;
    inherited;
  end;


procedure TfrmENAVRPlanShow.FormShow(Sender: TObject);
var
...
procedure TfrmENAVRPlanShow.sgENPlanWorkTopLeftChanged(Sender: TObject);
var
  TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENAVRPlanShow.sgENPlanWorkDblClick(Sender: TObject);
Var
temp : Integer;
begin
...
procedure TfrmENAVRPlanShow.UpdateGrid(Sender: TObject);
Var i, j: Integer;
begin
...
procedure TfrmENAVRPlanShow.actViewExecute(Sender: TObject);
...
begin
  ...
  frmENAVRPlanEdit:=TfrmENAVRPlanEdit.Create(Application, dsView);
  try

    try
      frmENAVRPlanEdit.ENPlanWorkObj := TempENPlanWork.getObject( objCode );
    except
      on EConvertError do Exit;
    end;

    frmENAVRPlanEdit.ShowModal;

  finally
    frmENAVRPlanEdit.Free;
    frmENAVRPlanEdit:=nil;
  end;

end;

procedure TfrmENAVRPlanShow.actEditExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
    tPlan : ENPlanWork;
    ObjCode: Integer;
begin
...
begin
  ...
  frmENAVRPlanEdit:=TfrmENAVRPlanEdit.Create(Application, dsEdit);
  try

     try
       frmENAVRPlanEdit.ENPlanWorkObj := TempENPlanWork.getObject(StrToInt(sgENPlanWork.Cells[0,sgENPlanWork.Row]));
     except
     on EConvertError do Exit;
    end;

    if frmENAVRPlanEdit.ShowModal= mrOk then
      begin
...
procedure TfrmENAVRPlanShow.actDeleteExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENAVRPlanShow.actInsertExecute(Sender: TObject);
var TempENPlanWork: ENPlanWorkControllerSoapPort;
...
begin
  ...
  selectedRow := sgENPlanWork.Row;
      ...
      frmENAVRPlanEdit := TfrmENAVRPlanEdit.Create(Application, dsInsert);
  try
      frmENAVRPlanEdit.ENPlanWorkObj:=ENPlanWork.Create;
       SetNullIntProps(frmENAVRPlanEdit.ENPlanWorkObj);
      SetNullXSProps(frmENAVRPlanEdit.ENPlanWorkObj);
      frmENAVRPlanEdit.ENPlanWorkObj.dateEdit:= TXSDate.Create;

       if frmENAVRPlanEdit.ShowModal = mrOk then
      begin
        if frmENAVRPlanEdit.ENPlanWorkObj<>nil then
        begin
          ...
          begin
            ...
            SetNullIntProps(FilterObject);
            SetNullXSProps(FilterObject);
            ENPlanWorkFilter(FilterObject).code := frmENAVRPlanEdit.ENPlanWorkObj.code;
            ENPlanWorkFilter(FilterObject).conditionSQL := ' enplanwork.statuscode <> ' + IntToStr(ENPLANWORKSTATUS_OLDER);
          end;
          /////
...
procedure TfrmENAVRPlanShow.actUpdateExecute(Sender: TObject);
  begin
  selectedRow := sgENPlanWork.Row;
  UpdateGrid(Sender);
...
procedure TfrmENAVRPlanShow.actFilterExecute(Sender: TObject);
...
begin
  ...
  try
    ...
    frmENPlanWorkFilterEdit.cbENPlanWorkFormName]);

    ENPlanWorkFilterObj.typeRef := ENPlanWorkTypeRef.Create();
    ENPlanWorkFilterObj.typeRef.code := ENPLANWORKTYPE_AVR; //2;
    frmENPlanWorkFilterEdit.edtTypeName.Text := 'АВР';
    ENPlanWorkFilterObj.formRef := ENPlanWorkFormRef.Create;
    ENPlanWorkFilterObj.formRef.code := ENPLANWORKFORM_NOPLANNED; // Неплановые работы
    frmENPlanWorkFilterEdit.cbENPlanWorkFormName.ItemIndex := ENPLANWORKFORM_NOPLANNED;
...
procedure TfrmENAVRPlanShow.actFinishPlanWorkExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
    ENPlanWorkList: ENPlanWorkShortList;
    ENPlanWorkFilterObj: ENPlanWorkFilter;
    ObjCode: Integer;
...
procedure TfrmENAVRPlanShow.actNoFilterExecute(Sender: TObject);
begin
  FilterObject.Free;
  FilterObject := nil;
  UpdateGrid(Sender);
...
procedure TfrmENAVRPlanShow.actEstimateExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
begin
...
procedure TfrmENAVRPlanShow.actCancelEstimateExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
begin
...
procedure TfrmENAVRPlanShow.actChangeObjectForPlanExecute(Sender: TObject);
var objCode: Integer;
begin
  try
    objCode := StrToInt(sgENPlanWork.Cells[0, sgENPlanWork.Row]);
...
procedure TfrmENAVRPlanShow.actClosePlanExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
    ENPlanWorkList: ENPlanWorkShortList;
    ENPlanWorkFilterObj: ENPlanWorkFilter;
    ObjCode: Integer;
...
procedure TfrmENAVRPlanShow.actMovePlanExecute(Sender: TObject);
Var
...
procedure TfrmENAVRPlanShow.actCorrectPlanExecute(Sender: TObject);
begin
{
...
procedure TfrmENAVRPlanShow.actAddPlanItemsExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
tPlan : ENPlanWork;
begin
  try
...
procedure TfrmENAVRPlanShow.actMakeNPZExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENAVRPlanShow.PopupMenu1Popup(Sender: TObject);
var
  plan : ENPlanWork;
...
procedure TfrmENAVRPlanShow.actPreConfirmExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENAVRPlanShow.actConfirmExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENAVRPlanShow.actUndoConfirmExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENAVRPlanShow.actUndoFinishPlanWorkExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
    ENPlanWorkList: ENPlanWorkShortList;
    ENPlanWorkFilterObj: ENPlanWorkFilter;
    ObjCode: Integer;
...
procedure TfrmENAVRPlanShow.actCreatePackExecute(Sender: TObject);
Var
//TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENAVRPlanShow.actUnCloseExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENAVRPlanShow.actSaveAddInfoExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
tPlan : ENPlanWork;
...
procedure TfrmENAVRPlanShow.actSaveFinexecutDepartmentExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
tPlan : ENPlanWork;
