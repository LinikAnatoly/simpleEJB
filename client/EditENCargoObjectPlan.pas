...
type
  TfrmENCargoObjectPlanEdit = class(TDialogForm)
...
var
  frmENCargoObjectPlanEdit: TfrmENCargoObjectPlanEdit;
  //ENPlanWorkObj: ENPlanWork;
...
procedure TfrmENCargoObjectPlanEdit.FormShow(Sender: TObject);
var
...
begin
  ...
  HideControls([lblCommentGen, edtCommentGen, lblENActNumber, edtENActNumber, spbENAct]); // только ФАКТ !!! ... акт покажем только для НПЗ или ФАКТА ...
  ...
  begin
    ...
    DisableControls([edtTypeName, spbType, edtWorkState, spbENPlanWorkState, spbENElement, edtENElementName,
                     ...
                     cbENPlanWorkFormName, cbPlanWorkKind]);
    ...
    ENPlanWorkItemObj.countGen.decimalString := '1';
...
procedure TfrmENCargoObjectPlanEdit.FormClose(Sender: TObject;  var Action: TCloseAction);
...
//      ENPlanWorkObj.dateGen := nil;
   ...
   ENPlanWorkObj.formRef.code := cbENPlanWorkFormName.ItemIndex + 1;
    ...
    begin
      ...
      if frmENCargoObjectPlanEdit.molCode <> '' then
      begin
        TempENMOL2PlanWork :=  HTTPRIOENMOL2PlanWork as ENMOL2PlanWorkControllerSoapPort;
        ...
        ENMOL2PlanWorkObj.molCode := frmENCargoObjectPlanEdit.molCode;
        ENMOL2PlanWorkObj.molName := frmENCargoObjectPlanEdit.molName;
...
procedure TfrmENCargoObjectPlanEdit.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmENCargoObjectPlanEdit.spbENPlanWorkStatusClick(Sender : TObject);
var
...
procedure TfrmENCargoObjectPlanEdit.spbENElementClick(Sender: TObject);
var
...
procedure TfrmENCargoObjectPlanEdit.updateFINMaterialsGrid(estimateItemCode : Integer; stringGrid : TAdvStringGrid );
var
...
procedure TfrmENCargoObjectPlanEdit.pcPlanWorkChange(Sender: TObject);
var
  TempENPlanWorkItem: ENPlanWorkItemControllerSoapPort;
...
procedure TfrmENCargoObjectPlanEdit.actInsertExecute(Sender: TObject);
  ...
  // -------------------------------------------------------------------------------------------
{
  ...
  begin
    ...
    ENTransportRouteObj := ENTransportRouteObj.Create;
...
procedure TfrmENCargoObjectPlanEdit.UpdateGrid(Sender: TObject);
Var i, j: Integer;
begin
 if pcPlanWork.ActivePage = tsPlanWorkItems then
 begin
...
procedure TfrmENCargoObjectPlanEdit.actEditExecute(Sender: TObject);
Var TempENPlanWorkItem: ENPlanWorkItemControllerSoapPort;
    TempENEstimateItem: ENEstimateItemControllerSoapPort;
begin
  //if ENPlanWorkObj.status.code <> ENPLANWORKSTATUS_GOOD then
...
procedure TfrmENCargoObjectPlanEdit.actViewExecute(Sender: TObject);
Var TempENPlanWorkItem: ENPlanWorkItemControllerSoapPort;
    TempENEstimateItem: ENEstimateItemControllerSoapPort;
    TempENTransportItem: ENTransportItemControllerSoapPort;
    TempENHumenItem: ENHumenItemControllerSoapPort;
...
procedure TfrmENCargoObjectPlanEdit.actUpdateExecute(Sender: TObject);
begin
  inherited;
  //selectedRow := sgENPlanWorkItem.Row;
  UpdateGrid(Sender);
...
procedure TfrmENCargoObjectPlanEdit.btnPlanReportClick(Sender: TObject);
var
...
procedure TfrmENCargoObjectPlanEdit.actDeleteExecute(Sender: TObject);
Var TempENPlanWorkItem: ENPlanWorkItemControllerSoapPort;
  ObjCode: Integer;
  TempENEstimateItem: ENEstimateItemControllerSoapPort;
  eType : integer;
...
procedure TfrmENCargoObjectPlanEdit.sgENPlanCorrectHistoryDblClick(
  Sender: TObject);
  var
  frmViewOldPlan : TfrmENCargoObjectPlanEdit;
  TempENPlanCorrectHistory : ENPlanCorrectHistoryControllerSoapPort;
  TempENPlanWork: ENPlanWorkControllerSoapPort;
...
begin
   ...
   frmViewOldPlan := TfrmENCargoObjectPlanEdit.Create(Application, dsView);
...
procedure TfrmENCargoObjectPlanEdit.spbENBudgetClick(Sender: TObject);
var
...
procedure TfrmENCargoObjectPlanEdit.spbResponsibilityClick(Sender: TObject);
var
   frmENDepartmentShow: TfrmENDepartmentShow;
   f : ENDepartmentFilter;
begin
...
procedure TfrmENCargoObjectPlanEdit.spbDepartmentClick(Sender: TObject);
var
   frmENDepartmentShow: TfrmENDepartmentShow;
   f : ENDepartmentFilter;
begin
...
procedure TfrmENCargoObjectPlanEdit.spbTypeClick(Sender: TObject);
var
...
procedure TfrmENCargoObjectPlanEdit.edtDateStartClick(Sender: TObject);
begin
//if edtDateStart.Checked then
//begin
...
procedure TfrmENCargoObjectPlanEdit.actMaterialBindingExecute(Sender: TObject);
begin
...
procedure TfrmENCargoObjectPlanEdit.PopupMenu1Popup(Sender: TObject);
begin
...
procedure TfrmENCargoObjectPlanEdit.edtDateStartChange(Sender: TObject);
begin
...
procedure TfrmENCargoObjectPlanEdit.spbENPlanWorkStateClick(Sender: TObject);
var
...
procedure TfrmENCargoObjectPlanEdit.spbENActClick(Sender: TObject);
var
  TempENAct: ENActControllerSoapPort;
  i: Integer;
...
procedure TfrmENCargoObjectPlanEdit.sgENEstimateItemClick(Sender: TObject);
var
  j : Integer;
begin
     // выведем список ФИН материалов .... если они есть ВААЩЕ ...
...
procedure TfrmENCargoObjectPlanEdit.actMaterialBindingToFINExecute(
  Sender: TObject);
var
    ...
    try
      ...
      begin
        ...
        //begin
        {
          ...
          //frmENCargoObjectPlanEdit.updateFINMaterialsGrid(temp);
...
procedure TfrmENCargoObjectPlanEdit.cbPlanWorkKindChange(Sender: TObject);
...
begin
  ...
  begin
    ...
    begin
      gbPlanMOL.Visible := true;
      DisableControls([edtMolName, spbPlanMOL, spbPlanMOLClear, edtMolName], false);
      DenyBlankValues([edtMolName]);
      NoBlankValues([edtMolName]);
...
procedure TfrmENCargoObjectPlanEdit.spbFINExecutorClick(Sender: TObject);
var
   frmFINExecutorTreeShow: TfrmFINExecutorTreeShow;
 //  f : EditENCargoObjectPlanStateFilter;
begin
...
function TfrmENCargoObjectPlanEdit.checkMaterialsBinding_(
...
procedure TfrmENCargoObjectPlanEdit.Shape1MouseDown(Sender: TObject;
...
procedure TfrmENCargoObjectPlanEdit.btnCloseAllClick(Sender: TObject);
var
  TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENCargoObjectPlanEdit.btnWorkOrderDetailsClick(Sender: TObject);
var
  TempENWorkOrder2ENPlanWork: ENWorkOrder2ENPlanWorkControllerSoapPort;
  i: Integer;
  ENWorkOrder2ENPlanWorkList: ENWorkOrder2ENPlanWorkShortList;
...
procedure TfrmENCargoObjectPlanEdit.actWorkOrderInsertExecute(Sender: TObject);
var
   TempENWorkOrder: ENWorkOrderControllerSoapPort;
   frmENWorkOrderEdit : TfrmENWorkOrderEdit;
   TempENWorkOrder2ENPlanWork : ENWorkOrder2ENPlanWorkControllerSoapPort;
...
procedure TfrmENCargoObjectPlanEdit.actWorkOrderEditExecute(Sender: TObject);
var
   TempENWorkOrder: ENWorkOrderControllerSoapPort;
   frmENWorkOrderEdit : TfrmENWorkOrderEdit;
   TempENWorkOrder2ENPlanWork : ENWorkOrder2ENPlanWorkControllerSoapPort;
...
procedure TfrmENCargoObjectPlanEdit.LoadMOLData(workOrderCode : Integer);
var
  i,j : Integer;
  f : FINMOLDataFilter;
...
procedure TfrmENCargoObjectPlanEdit.LoadWorkOrder;
var
  TempENWorkOrder2ENPlanWork: ENWorkOrder2ENPlanWorkControllerSoapPort;
...
procedure TfrmENCargoObjectPlanEdit.actWorkOrderUpdateExecute(Sender: TObject);
begin
  LoadWorkOrder;
end;

procedure TfrmENCargoObjectPlanEdit.spbFINMolClick(Sender: TObject);
var
 f : FINMolFilter;
...
procedure TfrmENCargoObjectPlanEdit.InitWorkOrderFields;
begin
  DisableControls([edtWorkOrderCode]);
...
procedure TfrmENCargoObjectPlanEdit.btnWorkOrderSaveClick(Sender: TObject);
var
   TempENWorkOrder: ENWorkOrderControllerSoapPort;
   TempENWorkOrder2ENPlanWork : ENWorkOrder2ENPlanWorkControllerSoapPort;
begin
...
procedure TfrmENCargoObjectPlanEdit.btnWorkOrderCancelClick(Sender: TObject);
begin
  ClearWorkOrderFields;
  LoadWorkOrder;
  WorkOrderEditState := dsView;
...
procedure TfrmENCargoObjectPlanEdit.ClearWorkOrderFields;
begin
...
procedure TfrmENCargoObjectPlanEdit.spbFINMechanicClick(Sender: TObject);
var
 f : FINMolFilter;
 frmFINMolShow : TfrmFINMolShow;
...
procedure TfrmENCargoObjectPlanEdit.pcPlanWorkChanging(Sender: TObject;
  var AllowChange: Boolean);
var answer: Integer;
begin
  AllowChange := true;
...
procedure TfrmENCargoObjectPlanEdit.actWorkOrderDeleteExecute(Sender: TObject);
var
   TempENWorkOrder: ENWorkOrderControllerSoapPort;
   frmENWorkOrderEdit : TfrmENWorkOrderEdit;
   TempENWorkOrder2ENPlanWork : ENWorkOrder2ENPlanWorkControllerSoapPort;
...
procedure TfrmENCargoObjectPlanEdit.cbShowAllClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmENCargoObjectPlanEdit.spbPlanMOLClick(Sender: TObject);
var
 f : FINMolFilter;
 frmFINMolShow : TfrmFINMolShow;
...
procedure TfrmENCargoObjectPlanEdit.spbPlanMOLClearClick(Sender: TObject);
var
  ENMOL2PlanWorkObj: ENMOL2PlanWork;
  TempENMOL2PlanWork: ENMOL2PlanWorkControllerSoapPort;
  ENMOL2PlanWorkFilterObj : ENMOL2PlanWorkFilter;
...
procedure TfrmENCargoObjectPlanEdit.actAddToRQOrderExecute(Sender: TObject);
var
  f : RQOrderFilter;
...
procedure TfrmENCargoObjectPlanEdit.actRemoveFromRQOrderExecute(Sender: TObject);
var
  TempRQOrderItem: RQOrderItemControllerSoapPort;
  j : Integer;
begin
...
procedure TfrmENCargoObjectPlanEdit.actMOLDataInsertExecute(Sender: TObject);
Var
  TempFINMolData: FINMolDataControllerSoapPort;
begin
  TempFINMolData := HTTPRIOFINMolData as FINMolDataControllerSoapPort;
...
procedure TfrmENCargoObjectPlanEdit.actMOLDataDeleteExecute(Sender: TObject);
Var
  TempFINMolData: FINMolDataControllerSoapPort;
  objCode : Integer;
begin
...
procedure TfrmENCargoObjectPlanEdit.actMOLDataEditExecute(Sender: TObject);
...
procedure TfrmENCargoObjectPlanEdit.actMOLDataViewExecute(Sender: TObject);
Var TempFINMolData: FINMolDataControllerSoapPort;
begin
 TempFINMolData := HTTPRIOFINMolData as FINMolDataControllerSoapPort;
   try
...
procedure TfrmENCargoObjectPlanEdit.actMOLDataUpdateExecute(Sender: TObject);
begin
  //inherited;
...
procedure TfrmENCargoObjectPlanEdit.spbBindingOverClick(Sender: TObject);
Var
TempENBindingOver: ENBindingOverControllerSoapPort;
...
procedure TfrmENCargoObjectPlanEdit.actExpToExcelExecute(Sender: TObject);
...
procedure TfrmENCargoObjectPlanEdit.actExpToExcel_materialExecute(
  Sender: TObject);
var AppPath, FileName: String;
    OldCursor: TCursor;
begin
...
procedure TfrmENCargoObjectPlanEdit.actExpToExcelDemontajExecute(Sender: TObject);
var AppPath, FileName: String;
    OldCursor: TCursor;
begin
  OldCursor := Screen.Cursor;
...
procedure TfrmENCargoObjectPlanEdit.actExpToExcelHumanExecute(Sender: TObject);
var AppPath, FileName: String;
    OldCursor: TCursor;
begin
  OldCursor := Screen.Cursor;
...
procedure TfrmENCargoObjectPlanEdit.actChangeEstimateItemStatusExecute(
  Sender: TObject);
  var
    TempENEstimateItem: ENEstimateItemControllerSoapPort;
...
procedure TfrmENCargoObjectPlanEdit.actSelectAllExecute(Sender: TObject);
begin
  inherited;
  checkGrid(sgENEstimateItem, 1, true);
end;

procedure TfrmENCargoObjectPlanEdit.actClearAllExecute(Sender: TObject);
begin
  inherited;
  checkGrid(sgENEstimateItem, 1, false);
end;

procedure TfrmENCargoObjectPlanEdit.actChangeEstimateItemStatusPLANEDExecute(
  Sender: TObject);
  var
    TempENEstimateItem: ENEstimateItemControllerSoapPort;
    i , newStatus, eCode : integer;
...
procedure TfrmENCargoObjectPlanEdit.updateMarksGrid(estimateItemCode : Integer; stringGrid : TAdvStringGrid );
var
...
procedure TfrmENCargoObjectPlanEdit.actMoveTOExecute(Sender: TObject);
var
...
procedure TfrmENCargoObjectPlanEdit.actMoveFromExecute(Sender: TObject);
var
  planFull : ENPlanWorkShort;
begin
  inherited;
