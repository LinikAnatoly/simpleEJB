unit ShowENPlanWriteOffProtection;
...
type
  TfrmENPlanWriteOffProtectionShow = class(TChildForm)
...
procedure actNoFilterExecute(Sender: TObject);
 ...
 public
   { Public declarations }
   isFiltered, isWriteOffProtection : boolean;
...
uses Main, EditENPlanWork, EditENPlanWorkFilter, ENConsts,
  ...
  EditENPlanTransPort, EditENPlanWriteOffProtection
...
procedure TfrmENPlanWriteOffProtectionShow.FormClose(Sender: TObject; var Action: TCloseAction);
  begin
    if FormMode = fmChild then
      frmENPlanWriteOffProtectionShow:=nil;
    inherited;
  end;


procedure TfrmENPlanWriteOffProtectionShow.FormShow(Sender: TObject);
var
  TempENPlanWork: ENPlanWorkControllerSoapPort;
  i, n : Integer;
  ENPlanWorkList: ENPlanWorkShortList;
  begin
  isWriteOffProtection := true;
  SetGridHeaders(ENPlanWorkHeaders, sgENPlanWork.ColumnHeaders);
  ColCount:=100;
  TempENPlanWork := HTTPRIOENPlanWork as ENPlanWorkControllerSoapPort;
  frmENPlanWriteOffProtectionShow.Caption:= 'Списання засобів захисту';
...
procedure TfrmENPlanWriteOffProtectionShow.sgENPlanWorkTopLeftChanged(Sender: TObject);
var
  TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENPlanWriteOffProtectionShow.sgENPlanWorkDblClick(Sender: TObject);
Var
temp : Integer;
begin
...
procedure TfrmENPlanWriteOffProtectionShow.UpdateGrid(Sender: TObject);
Var i, j: Integer;
begin
...
procedure TfrmENPlanWriteOffProtectionShow.actViewExecute(Sender: TObject);
...
begin
  ...
  frmENPlanWriteOffProtectionEdit:=TfrmENPlanWriteOffProtectionEdit.Create(Application, dsView);
  frmENPlanWriteOffProtectionEdit.isWriteOffProtection := true;
  try

    try
      frmENPlanWriteOffProtectionEdit.ENPlanWorkObj := TempENPlanWork.getObject( objCode );
    except
      on EConvertError do Exit;
    end;

    frmENPlanWriteOffProtectionEdit.ShowModal;

  finally
    frmENPlanWriteOffProtectionEdit.Free;
    frmENPlanWriteOffProtectionEdit:=nil;
  end;

end;

procedure TfrmENPlanWriteOffProtectionShow.actEditExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
    tPlan : ENPlanWork;
    ObjCode: Integer;
begin
...
begin
  ...
  frmENPlanWriteOffProtectionEdit:=TfrmENPlanWriteOffProtectionEdit.Create(Application, dsEdit);
  frmENPlanWriteOffProtectionEdit.isWriteOffProtection := true;
  try

     try
       frmENPlanWriteOffProtectionEdit.ENPlanWorkObj := TempENPlanWork.getObject(StrToInt(sgENPlanWork.Cells[0,sgENPlanWork.Row]));
     except
     on EConvertError do Exit;
    end;

    if frmENPlanWriteOffProtectionEdit.ShowModal= mrOk then
      begin
...
procedure TfrmENPlanWriteOffProtectionShow.actDeleteExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENPlanWriteOffProtectionShow.actInsertExecute(Sender: TObject);
var TempENPlanWork: ENPlanWorkControllerSoapPort;
...
begin
  ...
  try
    frmENPlanWriteOffProtectionEdit := TfrmENPlanWriteOffProtectionEdit.Create(Application, dsInsert);
    try

      frmENPlanWriteOffProtectionEdit.ENPlanWorkObj:=ENPlanWork.Create;
      SetNullIntProps(frmENPlanWriteOffProtectionEdit.ENPlanWorkObj);
      SetNullXSProps(frmENPlanWriteOffProtectionEdit.ENPlanWorkObj);
      //frmENPlanWriteOffProtectionEdit.ENPlanWorkObj.dateGen:= TXSDate.Create;NET-4213
      frmENPlanWriteOffProtectionEdit.ENPlanWorkObj.dateEdit:= TXSDate.Create;
      frmENPlanWriteOffProtectionEdit.isWriteOffProtection := true;

      frmENPlanWriteOffProtectionEdit.cbPlanWorkKind.ItemIndex := ENPLANWORKKIND_YEAR - 1;

      if frmENPlanWriteOffProtectionEdit.ShowModal = mrOk then

      begin
        if frmENPlanWriteOffProtectionEdit.ENPlanWorkObj<>nil then
        ...
        begin
         ...
         ENPlanWorkItemObj := TempENPlanWorkItem.getObject(frmENPlanWriteOffProtectionEdit.itemCode);

         frmENPlanWorkItemEdit := TfrmENPlanWorkItemEdit.Create(Application, dsEdit);
         //frmENPlanWorkItemEdit.pcEstimate.Visible := false;
         frmENPlanWorkItemEdit.isWriteOffProtection := true;
         ...
         if ShowModal = mrOk then
          ...
          begin
            ...
            SetNullIntProps(FilterObject);
            SetNullXSProps(FilterObject);
            ENPlanWorkFilter(FilterObject).code := frmENPlanWriteOffProtectionEdit.ENPlanWorkObj.code;
            ENPlanWorkFilter(FilterObject).conditionSQL := ' enplanwork.statuscode <> ' + IntToStr(ENPLANWORKSTATUS_OLDER);
          end;
          /////
...
procedure TfrmENPlanWriteOffProtectionShow.actUpdateExecute(Sender: TObject);
  begin
  selectedRow := sgENPlanWork.Row;
  UpdateGrid(Sender);
...
procedure TfrmENPlanWriteOffProtectionShow.actFilterExecute(Sender: TObject);
...
//    frmENPlanWorkFilterEdit.edtWorkState, frmENPlanWorkFilterEdit.spbENPlanWorkState
     ...
     frmENPlanWorkFilterEdit.HideControls([frmENPlanWorkFilterEdit.edtNumberList
    , frmENPlanWorkFilterEdit.edtPriConnectionNumber
    , frmENPlanWorkFilterEdit.lblNumberList
    , frmENPlanWorkFilterEdit.lblPriConnectionNumber]);


    ENPlanWorkFilterObj.typeRef := ENPlanWorkTypeRef.Create();
    ENPlanWorkFilterObj.typeRef.code := ENPLANWORKTYPE_WRITEOFF_PROTECTION; //18;
    frmENPlanWorkFilterEdit.edtTypeName.Text := 'Списання засобів захисту';
    ...
    frmENPlanWorkFilterEdit.isWriteOffProtection := true;
...
procedure TfrmENPlanWriteOffProtectionShow.actNoFilterExecute(Sender: TObject);
begin
  FilterObject.Free;
  FilterObject := nil;
  UpdateGrid(Sender);
...
procedure TfrmENPlanWriteOffProtectionShow.actEstimateExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
begin
...
procedure TfrmENPlanWriteOffProtectionShow.actCancelEstimateExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
begin
...
procedure TfrmENPlanWriteOffProtectionShow.actClosePlanExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
    ENPlanWorkList: ENPlanWorkShortList;
    ENPlanWorkFilterObj: ENPlanWorkFilter;
    ObjCode: Integer;
...
procedure TfrmENPlanWriteOffProtectionShow.actMovePlanExecute(Sender: TObject);
Var
...
procedure TfrmENPlanWriteOffProtectionShow.actCorrectPlanExecute(Sender: TObject);
begin
{
...
procedure TfrmENPlanWriteOffProtectionShow.actAddPlanItemsExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
tPlan : ENPlanWork;
begin
  try
...
procedure TfrmENPlanWriteOffProtectionShow.actMakeNPZExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENPlanWriteOffProtectionShow.PopupMenu1Popup(Sender: TObject);
var
  plan : ENPlanWork;
  ObjCode : Integer;
...
procedure TfrmENPlanWriteOffProtectionShow.actPreConfirmExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENPlanWriteOffProtectionShow.actConfirmExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENPlanWriteOffProtectionShow.actUndoConfirmExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENPlanWriteOffProtectionShow.actCreatePackExecute(Sender: TObject);
Var
//TempENPlanWork: ENPlanWorkControllerSoapPort;
...
procedure TfrmENPlanWriteOffProtectionShow.actUnCloseExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
ObjCode : Integer;
begin
...
procedure TfrmENPlanWriteOffProtectionShow.actSaveAddInfoExecute(Sender: TObject);
Var TempENPlanWork: ENPlanWorkControllerSoapPort;
tPlan : ENPlanWork;
