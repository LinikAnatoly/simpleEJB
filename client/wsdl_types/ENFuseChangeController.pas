//Контроллер Замен Предохранителей
...
//???
  ...
  ['{df67df67-df67-df67-df67-df67df67df67}']
    ...
    procedure installFuse(const anObject: ENFuse; //Установить предохранитель
      const aFChObject: ENFuseChange); stdcall;
    procedure uninstallFuse(const anObject: ENFuse; //Снять предохранитель
      const aFChObject: ENFuseChange); stdcall;
    procedure changeFuse(const anObjectOld: ENFuse; //Заменить предохранитель
