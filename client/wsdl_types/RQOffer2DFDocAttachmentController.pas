unit RQOffer2DFDocAttachmentController;
...
type
  ...
  RQOffer2DFDocAttachment            = class;                 { "http://ksoe.org/EnergyproControllerService/type/" }
  ...
  // ************************************************************************ //
  RQOffer2DFDocAttachmentRef = class(TRemotable)
  private
    Fcode: Integer;
  published
  ...
  // Namespace : http://ksoe.org/EnergyproControllerService/type/
  // ************************************************************************ //
  RQOffer2DFDocAttachment = class(TRemotable)
  private
    Fcode : Integer;
...
{
  RQOffer2DFDocAttachmentFilter = class(TRemotable)
  private
...
//???
  ...
  RQOffer2DFDocAttachmentFilter = class(RQOffer2DFDocAttachment)
  private
    FconditionSQL: WideString;
    ForderBySQL: WideString;
  public
  ...
  RQOffer2DFDocAttachmentShort = class(TRemotable)
  private
    Fcode : Integer;
    FcommentGen : WideString;
    FuserAdd : WideString;
  ...
  ArrayOfRQOffer2DFDocAttachmentShort = array of RQOffer2DFDocAttachmentShort;  // { "http://ksoe.org/EnergyproControllerService/type/" }

  RQOffer2DFDocAttachmentShortList = class(TRemotable)
  private
    FtotalCount: Integer;
    Flist: ArrayOfRQOffer2DFDocAttachmentShort;
  public
  destructor Destroy; override;
  published
    property totalCount: Integer read FtotalCount write FtotalCount;
    property list: ArrayOfRQOffer2DFDocAttachmentShort read Flist write Flist;
  end;

  ArrayOfInteger = array of Integer;

  // ************************************************************************ //
  // Namespace : http://ksoe.org/RQOffer2DFDocAttachmentController/message/
  // soapAction: http://ksoe.org/RQOffer2DFDocAttachmentController/action/RQOffer2DFDocAttachmentController.%operationName%
  // transport : http://schemas.xmlsoap.org/soap/http
  // style     : rpc
  // binding   : RQOffer2DFDocAttachmentControllerSoapBinding
  // service   : EnergyproControllerService
  // port      : RQOffer2DFDocAttachmentController
  // URL       : http://soap.ksoe.com.ua/energypro
  // ************************************************************************ //


  RQOffer2DFDocAttachmentControllerSoapPort = interface(IInvokable)
  ['{C5FADF30-A32C-4838-A8C0-2095F7214C24}']
    function add(const aRQOffer2DFDocAttachment: RQOffer2DFDocAttachment): Integer; stdcall;
    procedure remove(const anObjectCode: Integer); stdcall;
    procedure save(const aRQOffer2DFDocAttachment: RQOffer2DFDocAttachment); stdcall;
    function getObject(const anObjectCode: Integer): RQOffer2DFDocAttachment; stdcall;
    function getList: RQOffer2DFDocAttachmentShortList; stdcall;
    function getFilteredList(const aRQOffer2DFDocAttachmentFilter: RQOffer2DFDocAttachmentFilter): RQOffer2DFDocAttachmentShortList; stdcall;
    function getScrollableList(const aFromPosition: Integer; const aQuantity: Integer): RQOffer2DFDocAttachmentShortList; stdcall;
    function getScrollableFilteredList(const aRQOffer2DFDocAttachmentFilter: RQOffer2DFDocAttachmentFilter; const aFromPosition: Integer; const aQuantity: Integer): RQOffer2DFDocAttachmentShortList; stdcall;
    function getScrollableListByCondition(const aCondition: WideString; const aFromPosition: Integer; const aQuantity: Integer): RQOffer2DFDocAttachmentShortList; stdcall;
    function getScrollableFilteredCodeArray(const aRQOffer2DFDocAttachmentFilter: RQOffer2DFDocAttachmentFilter; const aFromPosition: Integer; const aQuantity: Integer): ArrayOfInteger; stdcall;
    function getShortObject(const anObjectCode: Integer): RQOffer2DFDocAttachmentShort; stdcall;
  end;


implementation

  destructor RQOffer2DFDocAttachment.Destroy;
  begin
...
{
  destructor RQOffer2DFDocAttachmentFilter.Destroy;
  begin
    if Assigned(FdateAdd) then
      dateAdd.Free;
    if Assigned(FdateEdit) then
  ...
  destructor RQOffer2DFDocAttachmentShort.Destroy;
  begin
    if Assigned(FdateAdd) then
      dateAdd.Free;
    if Assigned(FdateEdit) then
  ...
  destructor RQOffer2DFDocAttachmentShortList.Destroy;
  var
    I: Integer;
  begin
...
initialization
  ...
  RemClassRegistry.RegisterXSClass(RQOffer2DFDocAttachment, 'http://ksoe.org/EnergyproControllerService/type/', 'RQOffer2DFDocAttachment');
  RemClassRegistry.RegisterXSClass(RQOffer2DFDocAttachmentRef, 'http://ksoe.org/EnergyproControllerService/type/', 'RQOffer2DFDocAttachmentRef');
  RemClassRegistry.RegisterXSClass(RQOffer2DFDocAttachmentFilter, 'http://ksoe.org/EnergyproControllerService/type/', 'RQOffer2DFDocAttachmentFilter');
  RemClassRegistry.RegisterXSClass(RQOffer2DFDocAttachmentShort, 'http://ksoe.org/EnergyproControllerService/type/', 'RQOffer2DFDocAttachmentShort');
  RemClassRegistry.RegisterXSClass(RQOffer2DFDocAttachmentShortList, 'http://ksoe.org/EnergyproControllerService/type/', 'RQOffer2DFDocAttachmentShortList');
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOfRQOffer2DFDocAttachmentShort), 'http://ksoe.org/EnergyproControllerService/type/', 'ArrayOfRQOffer2DFDocAttachmentShort');

  InvRegistry.RegisterInterface(TypeInfo(RQOffer2DFDocAttachmentControllerSoapPort), 'http://ksoe.org/RQOffer2DFDocAttachmentController/message/', 'UTF-8');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(RQOffer2DFDocAttachmentControllerSoapPort), 'http://ksoe.org/RQOffer2DFDocAttachmentController/action/RQOffer2DFDocAttachmentController.%operationName%');
