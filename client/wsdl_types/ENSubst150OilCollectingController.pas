unit ENSubst150OilCollectingController;
...
type
  ...
  ENSubst150OilCollecting            = class;                 { "http://ksoe.org/EnergyproControllerService/type/" }
  ...
  // ************************************************************************ //
  ENSubst150OilCollectingRef = class(TRemotable)
  private
    Fcode: Integer;
  published
  ...
  // Namespace : http://ksoe.org/EnergyproControllerService/type/
  // ************************************************************************ //
  ENSubst150OilCollecting = class(TRemotable)
  private
    Fcode : Integer;
    Fname : WideString;
...
{
  ENSubst150OilCollectingFilter = class(TRemotable)
  private
...
//???
  ...
  ENSubst150OilCollectingFilter = class(ENSubst150OilCollecting)
  private
    FconditionSQL: WideString;
    ForderBySQL: WideString;
  public
  ...
  ENSubst150OilCollectingShort = class(TRemotable)
  private
    Fcode : Integer;
    Fname : WideString;
    FfactoryNumber : WideString;
  ...
  ArrayOfENSubst150OilCollectingShort = array of ENSubst150OilCollectingShort;  // { "http://ksoe.org/EnergyproControllerService/type/" }

  ENSubst150OilCollectingShortList = class(TRemotable)
  private
    FtotalCount: Integer;
    Flist: ArrayOfENSubst150OilCollectingShort;
  public
  destructor Destroy; override;
  published
    property totalCount: Integer read FtotalCount write FtotalCount;
    property list: ArrayOfENSubst150OilCollectingShort read Flist write Flist;
  end;


  // ************************************************************************ //
  // Namespace : http://ksoe.org/ENSubst150OilCollectingController/message/
  // soapAction: http://ksoe.org/ENSubst150OilCollectingController/action/ENSubst150OilCollectingController.%operationName%
  // transport : http://schemas.xmlsoap.org/soap/http
  // style     : rpc
  // binding   : ENSubst150OilCollectingControllerSoapBinding
  // service   : EnergyproControllerService
  // port      : ENSubst150OilCollectingController
  // URL       : http://soap.ksoe.com.ua/energypro
  // ************************************************************************ //


  ENSubst150OilCollectingControllerSoapPort = interface(IInvokable)
  ['{838B2BBB-0B77-4FA0-B8E4-54A676F8C9B6}']
    function add(const aENSubst150OilCollecting: ENSubst150OilCollecting): Integer; stdcall;
    procedure remove(const anObjectCode: Integer); stdcall;
    procedure save(const aENSubst150OilCollecting: ENSubst150OilCollecting); stdcall;
    function getObject(const anObjectCode: Integer): ENSubst150OilCollecting; stdcall;
    function getList: ENSubst150OilCollectingShortList; stdcall;
    function getFilteredList(const aENSubst150OilCollectingFilter: ENSubst150OilCollectingFilter): ENSubst150OilCollectingShortList; stdcall;
    function getScrollableList(const aFromPosition: Integer; const aQuantity: Integer): ENSubst150OilCollectingShortList; stdcall;
    function getScrollableFilteredList(const aENSubst150OilCollectingFilter: ENSubst150OilCollectingFilter; const aFromPosition: Integer; const aQuantity: Integer): ENSubst150OilCollectingShortList; stdcall;
    function getScrollableListByCondition(const aCondition: WideString; const aFromPosition: Integer; const aQuantity: Integer): ENSubst150OilCollectingShortList; stdcall;
    function getScrollableFilteredCodeArray(const aENSubst150OilCollectingFilter: ENSubst150OilCollectingFilter; const aFromPosition: Integer; const aQuantity: Integer): ArrayOfInteger; stdcall;
    function getShortObject(const anObjectCode: Integer): ENSubst150OilCollectingShort; stdcall;
  end;


implementation

  destructor ENSubst150OilCollecting.Destroy;
  begin
...
{
  destructor ENSubst150OilCollectingFilter.Destroy;
  begin
    if Assigned(FcurrentNominal) then
      currentNominal.Free;
    if Assigned(FdateEdit) then
  ...
  destructor ENSubst150OilCollectingShort.Destroy;
  begin
    if Assigned(FcurrentNominal) then
      currentNominal.Free;
  ...
  destructor ENSubst150OilCollectingShortList.Destroy;
  var
    I: Integer;
  begin
...
initialization
  ...
  RemClassRegistry.RegisterXSClass(ENSubst150OilCollecting, 'http://ksoe.org/EnergyproControllerService/type/', 'ENSubst150OilCollecting');
  RemClassRegistry.RegisterXSClass(ENSubst150OilCollectingRef, 'http://ksoe.org/EnergyproControllerService/type/', 'ENSubst150OilCollectingRef');
  RemClassRegistry.RegisterXSClass(ENSubst150OilCollectingFilter, 'http://ksoe.org/EnergyproControllerService/type/', 'ENSubst150OilCollectingFilter');
  RemClassRegistry.RegisterXSClass(ENSubst150OilCollectingShort, 'http://ksoe.org/EnergyproControllerService/type/', 'ENSubst150OilCollectingShort');
  RemClassRegistry.RegisterXSClass(ENSubst150OilCollectingShortList, 'http://ksoe.org/EnergyproControllerService/type/', 'ENSubst150OilCollectingShortList');
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOfENSubst150OilCollectingShort), 'http://ksoe.org/EnergyproControllerService/type/', 'ArrayOfENSubst150OilCollectingShort');

  InvRegistry.RegisterInterface(TypeInfo(ENSubst150OilCollectingControllerSoapPort), 'http://ksoe.org/ENSubst150OilCollectingController/message/', 'UTF-8');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(ENSubst150OilCollectingControllerSoapPort), 'http://ksoe.org/ENSubst150OilCollectingController/action/ENSubst150OilCollectingController.%operationName%');
