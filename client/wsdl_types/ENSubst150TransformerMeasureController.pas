unit ENSubst150TransformerMeasureController;
...
type
  ...
  ENSubst150TransformerMeasure            = class;                 { "http://ksoe.org/EnergyproControllerService/type/" }
  ...
  // ************************************************************************ //
  ENSubst150TransformerMeasureRef = class(TRemotable)
  private
    Fcode: Integer;
  published
  ...
  // Namespace : http://ksoe.org/EnergyproControllerService/type/
  // ************************************************************************ //
  ENSubst150TransformerMeasure = class(TRemotable)
  private
    Fcode : Integer;
    Fname : WideString;
...
{
  ENSubst150TransformerMeasureFilter = class(TRemotable)
  private
...
//???
  ...
  ENSubst150TransformerMeasureFilter = class(ENSubst150TransformerMeasure)
  private
    FconditionSQL: WideString;
    ForderBySQL: WideString;
  public
  ...
  ENSubst150TransformerMeasureShort = class(TRemotable)
  private
    Fcode : Integer;
    Fname : WideString;
    FfactoryNumber : WideString;
  ...
  ArrayOfENSubst150TransformerMeasureShort = array of ENSubst150TransformerMeasureShort;  // { "http://ksoe.org/EnergyproControllerService/type/" }

  ENSubst150TransformerMeasureShortList = class(TRemotable)
  private
    FtotalCount: Integer;
    Flist: ArrayOfENSubst150TransformerMeasureShort;
  public
  destructor Destroy; override;
  published
    property totalCount: Integer read FtotalCount write FtotalCount;
    property list: ArrayOfENSubst150TransformerMeasureShort read Flist write Flist;
  end;


  // ************************************************************************ //
  // Namespace : http://ksoe.org/ENSubst150TransformerMeasureController/message/
  // soapAction: http://ksoe.org/ENSubst150TransformerMeasureController/action/ENSubst150TransformerMeasureController.%operationName%
  // transport : http://schemas.xmlsoap.org/soap/http
  // style     : rpc
  // binding   : ENSubst150TransformerMeasureControllerSoapBinding
  // service   : EnergyproControllerService
  // port      : ENSubst150TransformerMeasureController
  // URL       : http://soap.ksoe.com.ua/energypro
  // ************************************************************************ //


  ENSubst150TransformerMeasureControllerSoapPort = interface(IInvokable)
  ['{C7980070-8900-4038-9437-A088108FE53C}']
    function add(const aENSubst150TransformerMeasure: ENSubst150TransformerMeasure): Integer; stdcall;
    procedure remove(const anObjectCode: Integer); stdcall;
    procedure save(const aENSubst150TransformerMeasure: ENSubst150TransformerMeasure); stdcall;
    function getObject(const anObjectCode: Integer): ENSubst150TransformerMeasure; stdcall;
    function getList: ENSubst150TransformerMeasureShortList; stdcall;
    function getFilteredList(const aENSubst150TransformerMeasureFilter: ENSubst150TransformerMeasureFilter): ENSubst150TransformerMeasureShortList; stdcall;
    function getScrollableList(const aFromPosition: Integer; const aQuantity: Integer): ENSubst150TransformerMeasureShortList; stdcall;
    function getScrollableFilteredList(const aENSubst150TransformerMeasureFilter: ENSubst150TransformerMeasureFilter; const aFromPosition: Integer; const aQuantity: Integer): ENSubst150TransformerMeasureShortList; stdcall;
    function getScrollableListByCondition(const aCondition: WideString; const aFromPosition: Integer; const aQuantity: Integer): ENSubst150TransformerMeasureShortList; stdcall;
    function getScrollableFilteredCodeArray(const aENSubst150TransformerMeasureFilter: ENSubst150TransformerMeasureFilter; const aFromPosition: Integer; const aQuantity: Integer): ArrayOfInteger; stdcall;
    function getShortObject(const anObjectCode: Integer): ENSubst150TransformerMeasureShort; stdcall;
  end;


implementation

  destructor ENSubst150TransformerMeasure.Destroy;
  begin
...
{
  destructor ENSubst150TransformerMeasureFilter.Destroy;
  begin
    if Assigned(FcurrentNominal) then
      currentNominal.Free;
    if Assigned(FdateEdit) then
  ...
  destructor ENSubst150TransformerMeasureShort.Destroy;
  begin
    if Assigned(FcurrentNominal) then
      currentNominal.Free;
  ...
  destructor ENSubst150TransformerMeasureShortList.Destroy;
  var
    I: Integer;
  begin
...
initialization
  ...
  RemClassRegistry.RegisterXSClass(ENSubst150TransformerMeasure, 'http://ksoe.org/EnergyproControllerService/type/', 'ENSubst150TransformerMeasure');
  RemClassRegistry.RegisterXSClass(ENSubst150TransformerMeasureRef, 'http://ksoe.org/EnergyproControllerService/type/', 'ENSubst150TransformerMeasureRef');
  RemClassRegistry.RegisterXSClass(ENSubst150TransformerMeasureFilter, 'http://ksoe.org/EnergyproControllerService/type/', 'ENSubst150TransformerMeasureFilter');
  RemClassRegistry.RegisterXSClass(ENSubst150TransformerMeasureShort, 'http://ksoe.org/EnergyproControllerService/type/', 'ENSubst150TransformerMeasureShort');
  RemClassRegistry.RegisterXSClass(ENSubst150TransformerMeasureShortList, 'http://ksoe.org/EnergyproControllerService/type/', 'ENSubst150TransformerMeasureShortList');
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOfENSubst150TransformerMeasureShort), 'http://ksoe.org/EnergyproControllerService/type/', 'ArrayOfENSubst150TransformerMeasureShort');

  InvRegistry.RegisterInterface(TypeInfo(ENSubst150TransformerMeasureControllerSoapPort), 'http://ksoe.org/ENSubst150TransformerMeasureController/message/', 'UTF-8');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(ENSubst150TransformerMeasureControllerSoapPort), 'http://ksoe.org/ENSubst150TransformerMeasureController/action/ENSubst150TransformerMeasureController.%operationName%');
