unit ENSubst150BuildZruController;
...
type
  ...
  ENSubst150BuildZru            = class;                 { "http://ksoe.org/EnergyproControllerService/type/" }
  ...
  // ************************************************************************ //
  ENSubst150BuildZruRef = class(TRemotable)
  private
    Fcode: Integer;
  published
  ...
  // Namespace : http://ksoe.org/EnergyproControllerService/type/
  // ************************************************************************ //
  ENSubst150BuildZru = class(TRemotable)
  private
    Fcode : Integer;
    Fname : WideString;
...
{
  ENSubst150BuildZruFilter = class(TRemotable)
  private
...
//???
  ...
  ENSubst150BuildZruFilter = class(ENSubst150BuildZru)
  private
    FconditionSQL: WideString;
    ForderBySQL: WideString;
  public
  ...
  ENSubst150BuildZruShort = class(TRemotable)
  private
    Fcode : Integer;
    Fname : WideString;
    FfactoryNumber : WideString;
  ...
  ArrayOfENSubst150BuildZruShort = array of ENSubst150BuildZruShort;  // { "http://ksoe.org/EnergyproControllerService/type/" }

  ENSubst150BuildZruShortList = class(TRemotable)
  private
    FtotalCount: Integer;
    Flist: ArrayOfENSubst150BuildZruShort;
  public
  destructor Destroy; override;
  published
    property totalCount: Integer read FtotalCount write FtotalCount;
    property list: ArrayOfENSubst150BuildZruShort read Flist write Flist;
  end;


  // ************************************************************************ //
  // Namespace : http://ksoe.org/ENSubst150BuildZruController/message/
  // soapAction: http://ksoe.org/ENSubst150BuildZruController/action/ENSubst150BuildZruController.%operationName%
  // transport : http://schemas.xmlsoap.org/soap/http
  // style     : rpc
  // binding   : ENSubst150BuildZruControllerSoapBinding
  // service   : EnergyproControllerService
  // port      : ENSubst150BuildZruController
  // URL       : http://soap.ksoe.com.ua/energypro
  // ************************************************************************ //


  ENSubst150BuildZruControllerSoapPort = interface(IInvokable)
  ['{F063E091-9974-4409-A12D-3299D7A68C82}']
    function add(const aENSubst150BuildZru: ENSubst150BuildZru): Integer; stdcall;
    procedure remove(const anObjectCode: Integer); stdcall;
    procedure save(const aENSubst150BuildZru: ENSubst150BuildZru); stdcall;
    function getObject(const anObjectCode: Integer): ENSubst150BuildZru; stdcall;
    function getList: ENSubst150BuildZruShortList; stdcall;
    function getFilteredList(const aENSubst150BuildZruFilter: ENSubst150BuildZruFilter): ENSubst150BuildZruShortList; stdcall;
    function getScrollableList(const aFromPosition: Integer; const aQuantity: Integer): ENSubst150BuildZruShortList; stdcall;
    function getScrollableFilteredList(const aENSubst150BuildZruFilter: ENSubst150BuildZruFilter; const aFromPosition: Integer; const aQuantity: Integer): ENSubst150BuildZruShortList; stdcall;
    function getScrollableListByCondition(const aCondition: WideString; const aFromPosition: Integer; const aQuantity: Integer): ENSubst150BuildZruShortList; stdcall;
    function getScrollableFilteredCodeArray(const aENSubst150BuildZruFilter: ENSubst150BuildZruFilter; const aFromPosition: Integer; const aQuantity: Integer): ArrayOfInteger; stdcall;
    function getShortObject(const anObjectCode: Integer): ENSubst150BuildZruShort; stdcall;
  end;


implementation

  destructor ENSubst150BuildZru.Destroy;
  begin
...
{
  destructor ENSubst150BuildZruFilter.Destroy;
  begin
    if Assigned(FcurrentNominal) then
      currentNominal.Free;
    if Assigned(FdateEdit) then
  ...
  destructor ENSubst150BuildZruShort.Destroy;
  begin
    if Assigned(FcurrentNominal) then
      currentNominal.Free;
  ...
  destructor ENSubst150BuildZruShortList.Destroy;
  var
    I: Integer;
  begin
...
initialization
  ...
  RemClassRegistry.RegisterXSClass(ENSubst150BuildZru, 'http://ksoe.org/EnergyproControllerService/type/', 'ENSubst150BuildZru');
  RemClassRegistry.RegisterXSClass(ENSubst150BuildZruRef, 'http://ksoe.org/EnergyproControllerService/type/', 'ENSubst150BuildZruRef');
  RemClassRegistry.RegisterXSClass(ENSubst150BuildZruFilter, 'http://ksoe.org/EnergyproControllerService/type/', 'ENSubst150BuildZruFilter');
  RemClassRegistry.RegisterXSClass(ENSubst150BuildZruShort, 'http://ksoe.org/EnergyproControllerService/type/', 'ENSubst150BuildZruShort');
  RemClassRegistry.RegisterXSClass(ENSubst150BuildZruShortList, 'http://ksoe.org/EnergyproControllerService/type/', 'ENSubst150BuildZruShortList');
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOfENSubst150BuildZruShort), 'http://ksoe.org/EnergyproControllerService/type/', 'ArrayOfENSubst150BuildZruShort');

  InvRegistry.RegisterInterface(TypeInfo(ENSubst150BuildZruControllerSoapPort), 'http://ksoe.org/ENSubst150BuildZruController/message/', 'UTF-8');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(ENSubst150BuildZruControllerSoapPort), 'http://ksoe.org/ENSubst150BuildZruController/action/ENSubst150BuildZruController.%operationName%');
