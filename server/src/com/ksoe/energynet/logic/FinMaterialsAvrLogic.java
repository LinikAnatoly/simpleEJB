...
public class FinMaterialsAvrLogic extends LogicModule {

	public FinMaterialsAvrLogic(Connection connection, UserProfile userProfile) {
	...
	public FINMaterialsList getMaterialsList(FINMaterialsFilter aFilterObject,
	   ...
	   */
		public FINMaterialsList getMaterialsList(FINMaterialsFilter aFilterObject,
			...
			AXTransactionsLogic axLogic = new AXTransactionsLogic(connection, userProfile);
