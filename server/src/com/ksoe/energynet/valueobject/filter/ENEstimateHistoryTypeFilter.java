...
/**
 * Filter for ENEstimateHistoryType;
 *
 */

public class ENEstimateHistoryTypeFilter extends ENEstimateHistoryType {
    ...
    public ENEstimateHistoryTypeFilter() {
        code = Integer.MIN_VALUE;
        name = null;
    }

} // end of Filter for ENEstimateHistoryType
