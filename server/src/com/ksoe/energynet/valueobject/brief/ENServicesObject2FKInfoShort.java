...
package  com.ksoe.energynet.valueobject.brief;
  ...
  /**
  * Short Object for ENServicesObject2FKInfo;  	
  */
...
public class ENServicesObject2FKInfoShort implements Serializable {
	...
	public int servicesObjectKindFKRefCode = Integer.MIN_VALUE;
	public String servicesObjectKindFKRefName;
	...
	public void setServicesObjectKindFKRefCode(int aValue){
		servicesObjectKindFKRefCode = aValue;
	}
	public int getServicesObjectKindFKRefCode(){
		return servicesObjectKindFKRefCode;
	}

	public void setServicesObjectKindFKRefName(String aValue){
		servicesObjectKindFKRefName = aValue;
	}
	public String getServicesObjectKindFKRefName(){
		return servicesObjectKindFKRefName;
	}
