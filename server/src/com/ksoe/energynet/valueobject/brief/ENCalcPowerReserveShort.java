...
package  com.ksoe.energynet.valueobject.brief;
  ...
  /**
  * Short Object for ENCalcPowerReserve;  	
  */
...
public class ENCalcPowerReserveShort implements Serializable {
	...
	public int gauge150RefCode = Integer.MIN_VALUE;
	public int gaugeRefCode = Integer.MIN_VALUE;
	
	
	public String gvalues;
	public Date gdate;
	public String trname;
	public String trtypename;
	public int trnominalpower = Integer.MIN_VALUE;
	...
	public void setGauge150RefCode(int aValue){
		gauge150RefCode = aValue;
	}
	public int getGauge150RefCode(){
		return gauge150RefCode;
	}

	public void setGaugeRefCode(int aValue){
		gaugeRefCode = aValue;
	}
	public int getGaugeRefCode(){
		return gaugeRefCode;
	}
	...
	public int getTrnominalpower() {
		return trnominalpower;
	}

	public void setTrnominalpower(int trnominalpower) {
		this.trnominalpower = trnominalpower;
	}
