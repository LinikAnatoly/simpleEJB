...
/**
 * Short Object for ENFamilySize2ServicesObject;
 */
...
public class ENFamilySize2ServicesObjectShort implements Serializable {
	...
	public int relationRefCode = Integer.MIN_VALUE;
	public String relationRefRelation;
	...
	public void setRelationRefCode(int aValue) {
		relationRefCode = aValue;
	}

	public int getRelationRefCode() {
		return relationRefCode;
	}

	public void setRelationRefRelation(String aValue) {
		relationRefRelation = aValue;
	}

	public String getRelationRefRelation() {
		return relationRefRelation;
	}
