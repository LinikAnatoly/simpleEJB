...
package  com.ksoe.energynet.valueobject.brief;
  ...
  /**
  * Short Object for ENServices2CalcAdditionalItems;  	
  */
...
public class ENServices2CalcAdditionalItemsShort implements Serializable {
	...
	public int calcAdditionalItemTypeRefCode = Integer.MIN_VALUE;
	public String calcAdditionalItemTypeRefName;
	...
	public void setCalcAdditionalItemTypeRefCode(int aValue){
		calcAdditionalItemTypeRefCode = aValue;
	}
	public int getCalcAdditionalItemTypeRefCode(){
		return calcAdditionalItemTypeRefCode;
	}

	public void setCalcAdditionalItemTypeRefName(String aValue){
		calcAdditionalItemTypeRefName = aValue;
	}
	public String getCalcAdditionalItemTypeRefName(){
		return calcAdditionalItemTypeRefName;
	}
