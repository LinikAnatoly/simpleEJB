...
/**
* Short Object for ENCustomerWarrant;
*/

import java.math.BigDecimal;
import java.util.Date;

public class ENCustomerWarrantShort implements Serializable {
	...
	public Date getWarrantRefDateGen() {
		return warrantRefDateGen;
	}

	public void setWarrantRefDateGen(Date warrantRefDateGen) {
		this.warrantRefDateGen = warrantRefDateGen;
	}
